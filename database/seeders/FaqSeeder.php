    ...
    public function run()
    {
        DB::table('faqs')->insert([
            [
                ...
                'answer' => 'At Danyel Sas, we specialize in a wide range of garments, including casual wear, formal attire, sportswear, and more.',
                'order' => 1,
            ],
            [
            ...
            [
                ...
                'answer' => 'At Danyel Sas, our garments are crafted with attention to detail and a focus on quality fabrics. We prioritize comfort, style, and durability in every design we offer.',
                'order' => 3,
            ],
            [
